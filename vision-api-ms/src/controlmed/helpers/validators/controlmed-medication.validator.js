...
const createMedicationSchema = Joi.object({
    ...
    // ===============================
    // 💊 MEDICATION (Tratamientos activos)
    // ===============================
        ...
        .items(
            Joi.object({
                ...
                dosage: Joi.string().max(50).allow('', null)
                    .messages({ 'string.max': 'La dosis no puede superar los 50 caracteres.' }),
                frequency: Joi.string().max(50).allow('', null)
                    .messages({ 'string.max': 'La frecuencia no puede superar los 50 caracteres.' }),
                ...
                notes: Joi.string().max(300).allow('', null)
                    .messages({ 'string.max': 'Las notas no pueden superar los 300 caracteres.' })
            })
        )
        .required()
        .messages({
