...
constants = {
    ...
    # 240P = 320X240, 360P = 640X360, 480P = 640X480, 720P = 1280X720, 1080P = 1920X1080
    "INGEST_VIDEO_WIDTH": int(os.getenv("INGEST_VIDEO_WIDTH", 640)),
    "INGEST_VIDEO_HEIGHT": int(os.getenv("INGEST_VIDEO_HEIGHT", 480)),
